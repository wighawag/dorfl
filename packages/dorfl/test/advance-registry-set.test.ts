 ...
 * and a STUBBED agent (injected `dorfl` edits files directly). It drives
...
beforeEach(() => {
	scratch = makeScratch('dorfl-advance-registry-set-');
 ...
 * rungs' ledger-write working tree). The injected `dorfl` edits files.
 */
