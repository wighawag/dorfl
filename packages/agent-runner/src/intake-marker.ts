 ...
 *
 * - `<!-- agent-runner:intake kind=ask seen=412,418 -->`
 * - `<!-- agent-runner:intake kind=bounced seen=503 -->`
 * - `<!-- agent-runner:intake kind=created slug=<slug> seen=601,602 -->`
 *
...
/** The marker's brand-derived namespace token (today `agent-runner:intake`). */
