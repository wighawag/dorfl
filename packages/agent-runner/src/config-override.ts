 ...
 * machine lever symmetric to CI's `AGENT_RUNNER_*` env, fixing "I can't make
 ...
 * `encodeRepoKey(arbiterUrl)` produces, e.g. `github-com/wighawag/agent-runner`)
 ...
 * never touch the real `~/.config/agent-runner/`.
 */
