...
- **Clearly-resolvable observations** → triage them (compose `triage-observations`: leave / promote into a self-contained task/prd/ADR / direct-delete) where the right outcome is obvious; the ambiguous ones become questions (step 3).
