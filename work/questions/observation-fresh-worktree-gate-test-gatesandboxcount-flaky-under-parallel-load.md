<!-- agent-runner-sidecar: item=observation:fresh-worktree-gate-test-gatesandboxcount-flaky-under-parallel-load type=observation slug=fresh-worktree-gate-test-gatesandboxcount-flaky-under-parallel-load allAnswered=false -->
