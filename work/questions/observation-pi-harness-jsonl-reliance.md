...
_Suggested default: promote-slice (a dedicated pi-harness-jsonl-polish slice, since the body already sketches concrete scope: audit the three call sites, evaluate non-scraping channels, preserve the LaunchResult.output seam)_
