<!-- dorfl-sidecar: item=observation:pr2b-run-continue-conflict-surface-unmoved type=observation slug=pr2b-run-continue-conflict-surface-unmoved allAnswered=false -->

Item: [`observation:pr2b-run-continue-conflict-surface-unmoved`](../notes/observations/pr2b-run-continue-conflict-surface-unmoved.md)
