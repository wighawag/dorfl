...
>
> FIRST, check this slice against current reality (drift). The agent-spawn / reporting-channel substrate is LANDED (SPEC 2026-06-09 UPDATE — `agent-stop`, review-gate). If it landed differently, reconcile or route to `needs-attention/`.
>
