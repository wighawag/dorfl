...
>
> TDD with vitest; stub the pi CLI where running real pi in CI is impractical, and document the seam contract. Match house style. "Done" = acceptance criteria met and `pnpm -r build && pnpm -r test && pnpm -r format:check` green.
