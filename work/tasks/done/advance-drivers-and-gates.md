...
>
> FIRST, check this slice against current reality (drift). The do/run convergence, the isolation seam, and `do prd:`-through-integration are LANDED substrate (SPEC 2026-06-09 UPDATE). If they landed differently, reconcile or route to `needs-attention/`.
>
