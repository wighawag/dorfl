...
- [ ] The internal deadline is resolved through the standard flag > env > per-repo > global > default chain; default 60 min; a config test covers the precedence.
