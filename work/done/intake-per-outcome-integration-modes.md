...
This is pure logic over the flag set + the runtime-decided artifact type; it sits in front of the `performIntegration` call the dispatcher already makes (slices 1 + 2).
