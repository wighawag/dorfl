...
Today the `enumerate` step builds the matrix from `agent-runner scan --json`
...
```sh
agent-runner claim ci-propose-matrix-enumerates-lifecycle-items --arbiter origin
