...
1. As the maintainer, I want `dorfl do prd:<slug>` to turn a PRD file into `work/backlog/` slices, so that slicing is a real capability (the `do` worker's PRD branch), not a manual ritual.
