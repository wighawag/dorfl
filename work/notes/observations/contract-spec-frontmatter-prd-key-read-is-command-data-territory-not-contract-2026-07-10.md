...
- dorfl's OWN ledger: **199 `prd:` frontmatter fields, 0 `spec:`** (`grep -rl '^prd:' work/` vs `'^spec:'`). Removing the `prd:` KEY read gives every dorfl task an `undefined` parent-spec pointer \u2014 wrong-but-compiling, breaks self-hosting.
